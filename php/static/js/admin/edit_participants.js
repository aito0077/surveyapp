(function(){
    ...
    Admin.EditProcessParticipants = Uif.View.extend({
        ...
        do_asociar: function() {
            var self = this;
            bootbox.confirm("You're going to bind the selected batch with the current process. Continue?", function(confirmed) {
                if(confirmed) {
                    self.asociar_batch();
                }
            });
        ...
        asociar_batch: function() {
           this.service_associate_batch.fetch({
                ...
                data: {
                    ...
                    process_code: this.model.get('code_process')
                }, 
    ...
    Admin.ParticipantsDatasource = Uif.View.extend({
        ...
        reset: function(batch) {
            this.column_definitions.reset(batch.get('meta_definitions'));
